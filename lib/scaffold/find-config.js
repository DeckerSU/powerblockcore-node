...
/**
 * Will return the path and powerblockcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'powerblockcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'powerblockcore-node.json'))
  };
}
