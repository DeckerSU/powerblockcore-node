...
var BASE_PACKAGE = {
  description: 'A full Litecoin node build with Litecore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'litecore-lib': '^' + bitcore.version,
    'litecore-node': version
  }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/litecore-node.json', configJSON);
      if (!isGlobal) {
