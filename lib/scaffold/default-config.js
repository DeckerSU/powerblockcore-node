...
/**
 * Will return the path and default powerblockcore-node configuration. It will search for the
 * configuration file in the "~/.powerblockcoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.powerblockcoin');
  var defaultConfigFile = path.resolve(defaultPath, './powerblockcore-node.json');
