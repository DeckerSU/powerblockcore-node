...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `powerblockcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ powerblockcore-node add wallet-service');
      console.log('    $ powerblockcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ powerblockcore-node remove wallet-service');
      console.log('    $ powerblockcore-node remove insight-api');
      console.log();
    });
