...
DB.prototype._setDataPath = function() {
  ...
  if (this.node.network === 'livenet' || this.node.network === 'mainnet') {
    this.dataPath = this.node.datadir + '/litecorenode.db';
  } else if (this.node.network === 'regtest') {
      this.dataPath = this.node.datadir + '/regtest/litecorenode.db';
  } else if (this.node.network === 'testnet') {
      this.dataPath = this.node.datadir + '/testnet/litecorenode.db';
  } else {
